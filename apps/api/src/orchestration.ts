import { JobDiagnostics, PreviewPayload, ImportJob, TemplateSuggestionResult } from "@shared/types";
...
export function analyzeJobDiagnostics(job: ImportJob): JobDiagnostics {
  return analyzePotentialIssues(job);
}
